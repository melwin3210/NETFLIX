...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e)=>e.preventDefault()}  className="w-4/12 absolute p-12 my-32 mx-auto right-0 left-0 text-white rounded-lg bg-black bg-opacity-80">
      <h1 className="font-bold text-3xl py-4">{isSignInForm?'Sign In' : 'Sign Up'}</h1>
      {!isSignInForm && <input ref={name} type="test" placeholder="Full Name" className="p-3 my-4 w-full bg-gray-700"></input> }
        <input type="email" ref={email} placeholder="Email Address" className="p-3 my-4 w-full bg-gray-700"></input>
        <input type="password" ref={password} placeholder="Password" className="p-3 my-4 w-full bg-gray-700"></input>
